...
// ==========================================
// 2. ESTADO GLOBAL (SE LLENARÁ DESDE LA NUBE)
// ==========================================
let distribuidores = [];
let vendedores = [];
let marcas = [];
...
// ==========================================
// 8. ASISTENTE VIRTUAL IA (RAG & CALENDARIO)
// ==========================================
...
// ==========================================
// 10. MÓDULO CRUD GENERAL (CREAR, EDITAR, BORRAR FIREBASE)
// ==========================================
...
async function eliminarDato(tipo, id) { 
  ...
  try {
    if(db) {
      ...
      if(tipo === 'marcas') await db.collection("marcas").doc(id.toString()).delete();
      ...
      if(tipo === 'marcas') { marcas = marcas.filter(m => m.id !== id); localStorage.setItem("marcas", JSON.stringify(marcas)); }
...
// ==========================================
// 11. GUARDAR VISITA (GPS Y FIREBASE)
// ==========================================
...
// ==========================================
// 12. IA GOOGLE GEMINI (VISUAL, COACHING Y REPORTE)
// ==========================================
...
// ==========================================
// 13. CALENDARIO E HISTORIAL DE AUDITORÍA
// ==========================================
...
// ==========================================
// 14. ESTADÍSTICAS Y PANEL DE CONTROL
// ==========================================
